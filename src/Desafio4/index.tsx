...
/* TODO
  ...
  Comentarios:
  1. remoção de list do array de dependencias. Uso de callback do setState para atualizar
  o valor de list.
  2. adicionado o count1 ao array de dependencia do useEffect
...
export const Desafio4 = () => {
  ...
  useEffect(() => {
    ...
    setTotal(totalCount);
    setList((prevList) => [...prevList, totalCount]);
